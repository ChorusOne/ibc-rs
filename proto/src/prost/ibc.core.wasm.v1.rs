...
pub mod msg_client {
    ...
    use tonic::codegen::*;
    #[doc = " Msg defines the ibc/wasm Msg service."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " PushNewWasmCode defines a rpc handler method for PushNewWasmCode."]
        pub async fn push_new_wasm_code(
            ...
            let path =
                http::uri::PathAndQuery::from_static("/ibc.core.wasm.v1.Msg/PushNewWasmCode");
...
pub mod query_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Query service for wasm module"]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Get Wasm code for given code id"]
        pub async fn wasm_code(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/ibc.core.wasm.v1.Query/WasmCode");
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
}
